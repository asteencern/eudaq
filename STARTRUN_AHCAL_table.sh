...
xterm -sb -sl 1000000 -T "Runcontrol" -e 'bin/euRun -n AhcalRunControl ; read '&
sleep 1  
#################  Log collector #################
...
xterm -sb -sl 100000 -T "directsave Data collector 3" -e 'bin/euCliCollector -n DirectSaveDataCollector -t dc3 ; read' &
...
xterm -sb -sl 1000000 -geometry 160x30 -T "DESY table" -e 'bin/euCliProducer -n DesyTableProducer -t desytable1 |tee -a logs/desytable.log ;read'&
