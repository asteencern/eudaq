...
//                  { 188, std::make_tuple(0, 12, 12) },
                  ...
                  {177, std::make_tuple(0, 18, 18) },
                  {178, std::make_tuple(0, 18, 12) },
                  {179, std::make_tuple(0, 12, 18) },
                  {180, std::make_tuple(0, 12, 12) },
                  {181, std::make_tuple(0, 18, 6) },
                  {182, std::make_tuple(0, 18, 0) },
                  {183, std::make_tuple(0, 12, 6) },
                  {184, std::make_tuple(0, 12, 0) },
                  {185, std::make_tuple(0, 6, 18) },
                  {186, std::make_tuple(0, 6, 12) },
                  {187, std::make_tuple(0, 0, 18) },
                  {188, std::make_tuple(0, 0, 12) },
                  {189, std::make_tuple(0, 6, 6) },
                  {190, std::make_tuple(0, 6, 0) },
                  {191, std::make_tuple(0, 0, 6) },
                  {192, std::make_tuple(0, 0, 0) },
                  ...
                  {129, std::make_tuple(3, 18, 18) },
                  {130, std::make_tuple(3, 18, 12) },
                  {131, std::make_tuple(3, 12, 18) },
                  {132, std::make_tuple(3, 12, 12) },
                  {133, std::make_tuple(3, 18, 6) },
                  {134, std::make_tuple(3, 18, 0) },
                  {135, std::make_tuple(3, 12, 6) },
                  {136, std::make_tuple(3, 12, 0) },
                  {137, std::make_tuple(3, 6, 18) },
                  {138, std::make_tuple(3, 6, 12) },
                  {139, std::make_tuple(3, 0, 18) },
                  {140, std::make_tuple(3, 0, 12) },
                  {141, std::make_tuple(3, 6, 6) },
                  {142, std::make_tuple(3, 6, 0) },
                  {143, std::make_tuple(3, 0, 6) },
                  {144, std::make_tuple(3, 0, 0) }
