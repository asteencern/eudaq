...
class CaliceAhcalBifBxidDataCollector: public eudaq::DataCollector {
   ...
   private:
      ...
      //to be edited according to the name of the processes
      ...
      bool m_evt_mandatory_hodoscope1 = false;
      bool m_evt_mandatory_hodoscope2 = false;
...
//      uint64_t ts_end = UINT64_C(0); //timestamps in 0.78125 ns steps
      ...
      //std::cout << "\tAHCALROC=" << roc_ahcal << ",AHCALBXID=" << bxid_ahcal << ",BIFROC=" << roc_bif << ",BIFBXID=" << bxid_bif << std::endl;
      ...
      if (m_evt_mandatory_ahcal && (!present_ahcal)) continue; //throw awway incomplete event
      if (m_evt_mandatory_bif && (!present_bif)) continue; //throw awway incomplete event
      if (m_evt_mandatory_hodoscope1 && (!present_hodoscope1)) continue; //throw awway incomplete event
      if (m_evt_mandatory_hodoscope2 && (!present_hodoscope2)) continue; //throw awway incomplete event
